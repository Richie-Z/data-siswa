...
public class form_kelas extends javax.swing.JFrame {
    ...
    public form_kelas() {
        initComponents();
        setTitle("Form Kelas - Aplikasi Data Siswa");
    ...
    private void tabel(){ 
        DefaultTableModel t= new DefaultTableModel();
         ...
         tbl.setModel(t); try{ res=stat.executeQuery("select * from kelas"); 
         while (res.next()) { 
         t.addRow(new Object[]{ res.getString("kode_kelas"),
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
         try {
            stat.executeUpdate("UPDATE kelas SET "
                + "kode_kelas='"+txtkode.getText()+"',"
                + "nama_kelas='"+txtnama.getText()+"'"

                + " WHERE " + "kode_kelas='"+txtkode.getText()+"'");
            kosongkan(); 
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        try { 
            res=stat.executeQuery("select * from kelas where "+ "kode_kelas='" +txtkode.getText()
            +"'" );
            while (res.next()) 
            {
                txtkode.setText(res.getString("kode_kelas")); 
                txtnama.setText(res.getString("nama_kelas"));
            }                                        
        }       
        catch (Exception e) { 
            JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        String kode_kelas=tbl.getValueAt(row,0).toString();
        String nama_kelas =tbl.getValueAt(row,1).toString();
        txtkode.setText(kode_kelas);
        txtnama.setText(nama_kelas);
