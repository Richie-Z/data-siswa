 ...
 * @author Richie
 */
public class form_matpel extends javax.swing.JFrame {
    ...
    public form_matpel() {
        initComponents();
        setTitle("Form Mata Pelajaran - Aplikasi Data Siswa");
    ...
    private void tabel(){ 
        DefaultTableModel t= new DefaultTableModel();
         t.addColumn("Kode Mata Pelajaran"); 
         t.addColumn("Mata Pelajaran"); 
         
         tbl.setModel(t); try{ res=stat.executeQuery("select * from mata_pelajaran"); 
         while (res.next()) { 
         t.addRow(new Object[]{ res.getString("kode_matapelajaran"),
         res.getString("nama_matapelajaran")
         }); 
         }
         }catch (Exception e) { 
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
         try {
            stat.executeUpdate("UPDATE mata_pelajaran SET "
                + "kode_matapelajaran='"+txtkode.getText()+"',"
                + "nama_matapelajaran='"+txtnama.getText()+"'"

                + " WHERE " + "kode_matapelajaran='"+txtkode.getText()+"'");
            kosongkan(); 
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        try { 
            res=stat.executeQuery("select * from mata_pelajaran where "+ "kode_matapelajaran='" +txtkode.getText()
            +"'" );
            while (res.next()) 
            {
                txtkode.setText(res.getString("kode_matapelajaran")); 
                txtnama.setText(res.getString("nama_matapelajaran"));
            }                                        
        }       
        catch (Exception e) { 
            JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        String kode_matapelajaran=tbl.getValueAt(row,0).toString();
        String nama_matapelajaran =tbl.getValueAt(row,1).toString();
        txtkode.setText(kode_matapelajaran);
        txtnama.setText(nama_matapelajaran);
