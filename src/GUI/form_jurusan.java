...
public class form_jurusan extends javax.swing.JFrame {
    ...
    public form_jurusan() {
        initComponents();
        setTitle("Form Jurusan - Aplikasi Data Siswa");
    ...
    private void tabel(){ 
        DefaultTableModel t= new DefaultTableModel();
         t.addColumn("Kode Jurusan"); 
         t.addColumn("Jurusan"); 
         
         tbl.setModel(t); try{ res=stat.executeQuery("select * from jurusan"); 
         while (res.next()) { 
         t.addRow(new Object[]{ res.getString("kode_jurusan"),
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
         try {
            stat.executeUpdate("UPDATE jurusan SET "
                + "kode_jurusan='"+txtkode.getText()+"',"
                + "nama_jurusan='"+txtnama.getText()+"'"

                + " WHERE " + "kode_jurusan='"+txtkode.getText()+"'");
            kosongkan(); 
    ...
    private void btncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncariActionPerformed
        try { 
            res=stat.executeQuery("select * from jurusan where "+ "kode_jurusan='" +txtkode.getText()
            +"'" );
            while (res.next()) 
            {
                txtkode.setText(res.getString("kode_jurusan")); 
                txtnama.setText(res.getString("nama_jurusan"));
            }                                        
        }       
        catch (Exception e) { 
            JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        String kode_jurusan=tbl.getValueAt(row,0).toString();
        String nama_jurusan =tbl.getValueAt(row,1).toString();
        txtkode.setText(kode_jurusan);
        txtnama.setText(nama_jurusan);
